...
export default function ProfilePage() {
    ...
    const [profileUser, setProfileUser] = useState<ProfileUser>(DEFAULT_PROFILE_USER);
    ...
    const handlePhoneDigitKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    const handleOpenProfileModal = () => {
        const phone =
            profileUser.phoneNumber === DEFAULT_PROFILE_USER.phoneNumber ? "" : profileUser.phoneNumber;
    ...
    const handleUpdateProfile = async () => {
        ...
        const phoneNumber = `${profileForm.phonePart1}${profileForm.phonePart2}${profileForm.phonePart3}`.replace(
            /\D/g,
            ""
        );
        ...
        try {
            ...
            window.dispatchEvent(new CustomEvent("auth-user-name-updated", { detail: { name } }));
            await loadProfile();
            router.refresh();
        } catch (error) {
            await Swal.fire({
            ...
            >
                <div className="space-y-4">
                    ...
                    <div className="flex justify-end gap-2 pt-2">
                        <Button variant="ghost" onClick={handleCloseProfileModal} disabled={isUpdatingProfile}>
                            취소
                        </Button>
